...
export const TESTIMONIALS = [
  {
    quote:
      "Splitr has made managing our group expenses so easy, I can finally focus on enjoying my trips!",
    name: "Alex Johnson",
  ...
  {
    quote:
      "Using Splitr has transformed how my friends and I handle shared expenses. It's so intuitive and reliable!",
    name: "Emily Davis",
  ...
  {
    quote:
      "Splitr's smart settlement feature saved us so much time and hassle. Highly recommend it for any group!",
    name: "Michael Smith",
  ...
  {
    quote:
      "The real-time updates in Splitr keep everyone informed and accountable. It's a game-changer for group expenses!",
    name: "Sarah Lee",
